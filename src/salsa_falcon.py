...
app = falcon.asgi.App()
hexenc = SalsaHexEncryptResource()
hexdec = SalsaHexDecryptResource()
rawenc = SalsaEncryptResource()
rawdec = SalsaDecryptResource()
app.add_route('/api/encrypt/0', hexenc)
app.add_route('/api/decrypt/0', hexdec)
app.add_route('/api/encrypt/1', rawenc)
app.add_route('/api/decrypt/1', rawdec)
